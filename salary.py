...
while i !="no":
     ...
     if i!= "no":
        ...
        amount=[rent_amount,electricty_amount,savings_amount]
        for i in range(len(amount)):
            if i ==0 :
                month["rent amount"]=amount[i]
            elif i ==1:
                month["elect amount"]=amount[i]
            else :
                month["savings amount"]=amount[i]
        ...
        detail =-1
        while detail !=0:
            display = int(input("If you want to display all the infos now please press any / No press 0:"))
            if display !=0:
                ...
                if detail ==1:
                    ...
                    print (f"the month is {month['name']}")
                    print (f"the salary before tax is = {salary_amount}")
                    print (f"the salary after tax is = {remainder} and without the additional saving is = {remainder+extra}")
                    print (f"the savings is = {savings_amount}")
                    print (f"the electricty is = {electricty_amount}")
